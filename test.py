...
from utils.utils import load_classes, xywh2xyxy
...
def evaluate(model, path, iou_thres, conf_thres, nms_thres, img_size, batch_size):
    ...
    for batch_i, (_, imgs, targets) in enumerate(dataloader):
        ...
        # Rescale target
        targets[:, 2:] = xywh2xyxy(targets[:, 2:]) # convert the coordinates from xywh to xyxy
        targets[:, 2:] *= img_size                 # scale the normalized targets to image size
